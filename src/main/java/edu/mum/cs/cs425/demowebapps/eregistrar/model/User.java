...
public class User implements UserDetails {
    ...
    public String getFullName() {
        // return (this.middleName == null || this.middleName.isBlank()) ?
        // String.format("%s %s", this.firstName, this.lastName) : String.format("%s %s
        // %s", this.firstName, this.middleName, this.lastName);
        return (this.middleName == null) ? String.format("%s %s", this.firstName, this.lastName)
